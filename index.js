...
const allowedOrigins = ["http://localhost:5173", "http://localhost:5174","https://fact-hunter-ggk7xv1qq-longhairs-projects.vercel.app", "https://facthunter.vercel.app"]
        ...
        origin: (origin, callback) => {
            if( !origin || allowedOrigins.includes(origin)){
               callback(null, true)     
                ...
                callback(new Error(
                    "origin not allowed by cors policy bla bla bla"
                ))  
            }
        }, 
